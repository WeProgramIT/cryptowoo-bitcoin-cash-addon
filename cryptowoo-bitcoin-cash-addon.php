...
if ( cwbch_hd_enabled() ) {
	...
	if( method_exists('Redux', 'set_field') ) {
		// Using Redux v4
		add_action( 'plugins_loaded', 'cwbch_add_fields_v4', 10 );
	} else {
		// Use embedded Redux v3
		add_action( 'plugins_loaded', 'cwbch_add_fields', 10 );  // TODO Remove after main plugin has Redux v4
	}
